...
This projects helps demonstrate clean, flexible, and maitainable code by levraging the following language constructs for Java,SpringBoot applications <br/>
1. Usage of javax.validators <br/>
